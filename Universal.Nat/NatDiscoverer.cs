...
namespace Universal.Nat
{
    ...
    public class TraceSource
    {
        ...
        public void TraceEvent(TraceEventType type, int i, string format, params object[] args)
        {
    ...
    {
        /// <summary>
        ///     The <see cref="http://msdn.microsoft.com/en-us/library/vstudio/system.diagnostics.tracesource">TraceSource</see>
        ///     instance
        ...
        /// </example>
        /// <remarks>
        ///     At least one trace listener has to be added to the Listeners collection if a trace is required; if no listener is
        ///     added
